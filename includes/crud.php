...
define('DOMAIN_URL', 'http://localhost/smartgram/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "smartgram";    // Change as required
